#!/usr/bin/env node
/**
 * PreToolUse Hook: Block dev server starts outside tmux.
 *
 * Prevents `npm run dev`, `pnpm dev`, `yarn dev`, `bun run dev` from
 * running directly. Forces use of tmux so logs remain accessible and
