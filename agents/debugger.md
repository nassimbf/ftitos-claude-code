...
Full step-by-step bodies for every technique below: @references/debugger-techniques.md
...
@references/debugger-bug-taxonomy.md
...
@references/debugger-repro-hardening.md
...
@references/debugger-semantic-recall.md
...
@references/debugger-rca-branching.md
...
@references/debugger-fix-acceptance.md
...
@references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
