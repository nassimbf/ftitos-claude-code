...
@references/gates.md
@references/verifier-phase-gates.md
@references/verifier-evidence-gate.md
</required_reading>
...
**agent_skills:** self-load per @references/agent-skills-bootstrap.md
</project_context>
...
@references/few-shot-examples/verifier.md
...
recipes: @references/verifier-wiring-patterns.md
...
@references/verifier-wiring-patterns.md
...
Structure gaps in YAML frontmatter for `/plan-phase --gaps`:
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@references/verify-mvp-mode.md`.
...
Structured gaps in VERIFICATION.md frontmatter for `/plan-phase --gaps`.
